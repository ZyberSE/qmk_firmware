...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    // clang-format off
    [0] = LAYOUT_60_hhkb(
        KC_ESC,   KC_1,     KC_2,     KC_3,     TD(SSHT),TD(MONO),KC_6,   KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,   KC_EQL,   KC_BSLS,  KC_GRV,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,    KC_T,    KC_Y,   KC_U,     KC_I,     KC_O,     KC_P,     TD(LBRC),  KC_RBRC,  KC_BSPC,
        KC_LCTL,  KC_A,     KC_S,     KC_D,     KC_F,    KC_G,    KC_H,   KC_J,     KC_K,     KC_L,     TD(SCLN), TD(QUOT),  KC_ENTER,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,   KC_V,     KC_B,   KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,   MO(1),
                  KC_LOPT,  KC_LGUI,                              KC_SPC,                               RO_SPTL,  KC_ROPT),
